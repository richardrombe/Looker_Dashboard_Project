...
1. **Demografis Pelanggan**
   ...
   + Selanjutnya yang dibahas dalam poin ini adalah jumlah nasabah berdasarkan status perkawinan. Separuh dari total nasabah yang menggunakan layanan bank ini sudah menikah (51.2% / 2.586 pelanggan). Kemudian untuk nasabah yang belum menikah menduduki posisi kedua dengan selisih hanya 10% dari nasabah yang telah menikah (41.5% / 2.099 pelanggan). Sisa dari total jumlah pelanggan merupakan nasabah yang tidak diketahui status perkawinannya (7.3% / 369 pelanggan).
