...
1. **Performa penjualan cenderung fluktuatif**. Jika dilihat pada grafik mengenai pemasukkan ritel dari periode awal hingga akhir, pergerakan nilai pendapatan cenderung tidak stabil. Contohnya untuk nilai pendapatan pada bulan Juni 2021 ke Juli 2021, terdapat kenaikan yang cukup signifikan, yaitu dari Rp 115.395.002 ke Rp 494.339.295 atau **naik hampir 4 kali lipat**. Di sisi lain yaitu terdapat penurunan tajam pendapatan ritel dalam periode bulan September 2022 dan Oktober 2022, dari Rp 660.452.467 ke Rp 124.809.272 atau **turun sekitar 5 kali lipat**. Hasil pendapatan terendah dalam ritel ini terjadi pada bulan April 2021, yakni sekitar Rp 81 juta dan pendapatan tertinggi terjadi satu tahun setelahnya, yakni pada bulan April 2022 dengan nominal sekitar Rp 698 juta.
2. **Metode pembayaran langsung tunai (COD) menjadi primadona pelanggan ketika bertansaksi**. Melihat pada grafik mengenai jumlah transaksi berdasarkan metode pembayaran, lebih dari setengah pelanggan yang bertransaksi di ritel ini (67.6%) memilih membayar langsung tunai saat barang tiba. Hal ini juga didukung dari grafik nilai transaksi berdasarkan metode pembayaran, yang menyatakan bahwa pembayaran COD memiliki nilai transaksi tersebesar, yaitu sekitar Rp 2.93 miliar.
3. **Produk *Mobiles & Tablets* lebih digemari pelanggan**. Hal ini terlihat dalam grafik transaksi pembelian produk berdasarkan kategori produk, bahwa sebanyak 2.745 transaksi (20.2%) produk merupakan produk elektronik seperti ponsel dan tablet. Pernyataan tersebut senada dengan nilai transaksi berdasarkan kategori produk dan subtotal dari tabel ringkasan mengenai transaksi produk, yakni jumlah nilai transaksi untuk produk elektronik ponsel dan tablet sebesar Rp 3.46 miliar, menempati urutan pertama. Mungkin ritel ini memberikan banyak promo pelanggan atau pelanggan membeli produk ponsel atau tablet dengan jumlah yang banyak.
4. **Diskon harga lebih difokuskan kepada produk hiburan**. Melalui grafik batang mengenai pengeluaran diskon, ritel memberikan lebih banyak potongan harga untuk produk dengan kategori *Entertainment* atau hiburan, dengan nominal sebesar Rp 8.86 juta. Produk hiburan dalam ritel ini beragam, mulai dari televisi, kamera, perangkat gim, pengeras suara, dan lain sebagainya.
5. **Terdapat dua pelanggan dengan jumlah transaksi terbesar**. Dari banyaknya pelanggan yang berbelanja melalui ritel ini, terdapat dua pelanggan dengan nominal transaksi lebih dari Rp 500 juta. Kedua pelanggan itu ialah `C206125L` dan `C460487L`. Walaupun tidak banyak bertransaksi dalam ritel ini, mereka telah membeli produk dengan jumlah yang banyak dalam sekali transaksi. Kedua pelanggan tersebut secara langsung menjadi kontributor terbesar bagi keuntungan ritel, dengan nilai keuntungan yang diraih sekitar Rp 66 juta.

## 💡 Recommendations (Rekomendasi Keberlangsungan Bisnis)
Penjabaran mengenai rekomendasi pada bagian ini dibuat berdasarkan hasil analisis data pada bagian sebelumnya, dengan tujuan untuk memberikan wawasan atau saran kepada pemangku kepentingan ritel demi keberlangsungan usaha. Berikut ini adalah beberapa saran yang disampaikan:
1. **Mengidentifikasi lebih lanjut performa penjualan yang tak menentu**. Manajer produk dapat berkoordinasi dengan pemangku kepentingan untuk mencari tahu akar penyebab dari penjualan yang tidak stabil, terlebih pada performa penjualan dari bulan September ke Oktober 2022 yang merosot tajam. Perusahaan ritel ini juga mungkin dapat melakukan *brainstorming* dalam memahami kebutuhan pelanggan dan kekuatan kompetitor bisnis untuk mengatasi penurunan penjualan yang tak terduga.
2. **Memberikan lebih banyak diskon untuk produk elektronik ponsel dan tablet**. Melihat banyaknya jumlah transaksi produk dengan kategori tersebut, ritel seharusnya bisa mempertimbangkan untuk memberikan potongan harga yang lebih untuk kategori ponsel dan tablet dan beberapa kategori lainnya. Hal ini merupakan strategi desentralisasi pemberian diskon agar kategori produk lain dapat terjual, khususnya untuk produk dengan kategori yang kurang laku terjual.
3. **Memberikan *reward* kepada pelanggan potensial**. Hal ini berguna untuk memberikan kesan kepada pelanggan yang telah bertransaksi dengan nominal terbesar agar tetap setia berbelanja dalam ritel ini. Pemberian hadiah dalam hal ini bisa berupa pemberian produk secara cuma-cuma dengan nilai transaksi tertentu atau kupon berbelanja pada saat *event* tertentu.
